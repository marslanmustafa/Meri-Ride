  ...
  return (
    <div className="p-5">
      <div className="w-full max-w-4xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
        <div className="p-4 bg-primary text-white text-lg font-semibold">
        ...
        <div className="p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <div className="mb-4">
                <label className="text-sm font-medium text-gray-700">Driving Violation History</label>
              ...
              <div className="mb-4">
                <label className="text-sm font-medium text-gray-700">Road Accident History</label>
              ...
              <div className="mb-4">
                <label className="text-sm font-medium text-gray-700">Authorization for Background Check</label>
                <div className="mt-1">{authorizationForBackgroundCheck ? "Yes" : "No"}</div>
              </div>
              <div className="mb-4">
                <label className="text-sm font-medium text-gray-700">Criminal History</label>
              ...
              <div className="mb-4">
                <label className="text-sm font-medium text-gray-700">Company Mission Agreement</label>
              ...
              <div className="mb-4">
                <label className="text-sm font-medium text-gray-700">Relevant Skills</label>
                <div className="mt-1">{relevantSkills}</div>
              </div>
              <div className="mb-4">
                <label className="text-sm font-medium text-gray-700">Why Work With Us</label>
              ...
              <div className="mb-4">
                <label className="text-sm font-medium text-gray-700">Agreement and Confirmation</label>
                <div className="mt-1">{agreeTermsAndCondition ? "Agreed to Terms and Conditions" : "Not Agreed"}</div>
                <div className="mt-1">{confirmAboutInfo ? "Confirmed about provided information" : "Not Confirmed"}</div>
              </div>
            </div>
          </div>
        </div>
